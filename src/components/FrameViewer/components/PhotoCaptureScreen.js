  ...
  if (!cameraPermission?.granted) {
    return (
      <SafeAreaView className="flex-1 justify-center items-center bg-gray-900">
        ...
        <TouchableOpacity className="bg-blue-500 rounded-full px-6 py-3" onPress={requestCameraPermission}>
        ...
        <View className="mt-4 flex-row justify-center items-center">
          {!photoUri ? (
            ...
            <View className="flex-row justify-center items-center space-x-8">
              <TouchableOpacity className="bg-red-500 p-3 rounded-full" onPress={discardPhoto}>
                <X color="white" size={24} />
              </TouchableOpacity>
              <TouchableOpacity className="bg-green-500 p-3 rounded-full" onPress={savePhoto}>
