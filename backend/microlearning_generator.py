...
class MicrolearningGenerator:
    ...
    def _generate_structured_learning(self, title: str, summary: str, 
        ...
        try:
            prompt = f"""You are an expert at creating engaging microlearning content.

Create a structured microlearning module (5-10 minutes to read) from this content.
...
Create 3-5 specific learning objectives for this microlearning module.
...
Create {num_questions} quiz questions (multiple choice or short answer) to test understanding of this content.
